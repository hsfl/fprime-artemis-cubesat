# ZephyrDeployment Application

This deployment was auto-generated by the F' utility tool.

## Building and Running the ZephyrDeployment Application

In order to build the ZephyrDeployment application, or any other F´ application, we first need to generate a build directory. This can be done with the following commands:
...
The next step is to build the ZephyrDeployment application's code.
```
fprime-util build
```
