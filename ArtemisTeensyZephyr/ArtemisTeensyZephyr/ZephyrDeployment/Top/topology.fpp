module ZephyrDeployment {
  ...
  deployment topology ZephyrDeployment {
  ...
  include "ZephyrDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections RateGroups {
      ...
      rateGroup1Hz.RateGroupMemberOut[6] -> bridgeShell.run
    }

    connections ZephyrDeployment {
