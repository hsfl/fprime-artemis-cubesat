// ======================================================================
// \title  ZephyrDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef ZEPHYRDEPLOYMENT_ZEPHYRDEPLOYMENTTOPOLOGY_HPP
#define ZEPHYRDEPLOYMENT_ZEPHYRDEPLOYMENTTOPOLOGY_HPP
// Included for access to ZephyrDeployment::TopologyState and ZephyrDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ArtemisTeensyZephyr/ZephyrDeployment/Top/ZephyrDeploymentTopologyDefs.hpp>

// Remove unnecessary ZephyrDeployment:: qualifications
using namespace ZephyrDeployment;
namespace ZephyrDeployment {
/**
 ...
 * ZephyrDeployment::TopologyState see: ZephyrDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ZephyrDeployment::TopologyState see: ZephyrDeploymentTopologyDefs.hpp.
 *
