...
// for example -DRF_ENDPOINT_PROFILE=RF_PROFILE_N2_GDS_A.
...
#define RF_ENDPOINT_PROFILE RF_PROFILE_N2_GDS_A
#endif

#if RF_ENDPOINT_PROFILE == RF_PROFILE_C3M_GDS
#define RF_ENDPOINT_PROFILE_NAME "c3m-gds"
...
#elif RF_ENDPOINT_PROFILE == RF_PROFILE_N2_GDS_A
#define RF_ENDPOINT_PROFILE_NAME "n2-gds-a"
static constexpr uint8_t RF_NETWORK_ID = 0xD2;
static constexpr uint8_t RF_PROTOCOL_VERSION = 0x01;
static constexpr uint8_t RF_LOCAL_ADDRESS = 0xA1;
static constexpr uint8_t RF_REMOTE_ADDRESS = 0xA2;
#elif RF_ENDPOINT_PROFILE == RF_PROFILE_N2_GDS_B
#define RF_ENDPOINT_PROFILE_NAME "n2-gds-b"
static constexpr uint8_t RF_NETWORK_ID = 0xD2;
static constexpr uint8_t RF_PROTOCOL_VERSION = 0x01;
static constexpr uint8_t RF_LOCAL_ADDRESS = 0xA4;
static constexpr uint8_t RF_REMOTE_ADDRESS = 0xA3;
#else
#error "Unknown or wrong-role RF_ENDPOINT_PROFILE for this ground/GDS firmware"
#endif
