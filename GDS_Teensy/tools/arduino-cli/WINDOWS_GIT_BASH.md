...
./tools/arduino-cli/build_windows_git_bash.sh --profile n2-gds-a
```
...
```bash
./tools/arduino-cli/upload_windows_git_bash.sh --profile n2-gds-a usb:0/140000/0/2
```
...
./tools/arduino-cli/upload.sh --profile n2-gds-a usb:100000
```

Use `n2-gds-b` only for the second GDS. Profile artifacts are kept in separate
