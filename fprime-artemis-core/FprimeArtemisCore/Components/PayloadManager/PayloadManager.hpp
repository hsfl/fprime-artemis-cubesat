...
#include "FprimeArtemisCore/Components/PayloadManager/PayloadManagerComponentAc.hpp"
...
class PayloadManager final : public PayloadManagerComponentBase {
  ...
  private:
    ...
    void driverStateIn_handler(FwIndexType portNum, const Components::PayloadState& payloadState) override;
    ...
    Components::PayloadState m_payloadState;
};
