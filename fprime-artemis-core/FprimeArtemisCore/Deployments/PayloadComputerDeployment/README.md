# PayloadComputerDeployment Application

This deployment was auto-generated by the F' utility tool.

## Building and Running the PayloadComputerDeployment Application

In order to build the PayloadComputerDeployment application, or any other F´ application, we first need to generate a build directory. This can be done with the following commands:

```
cd PayloadComputerDeployment
fprime-util generate
```

The next step is to build the PayloadComputerDeployment application's code.
```
fprime-util build
```
