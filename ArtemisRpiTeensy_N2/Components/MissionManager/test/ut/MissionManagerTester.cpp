...
void MissionManagerTester::testRejectsInvalidScheduleCommandInputs() {
    this->clearHistory();

    this->sendCmd_SCHEDULE_COLLECTION(0, 0, 0);
    this->component.doDispatch();
    ASSERT_CMD_RESPONSE_SIZE(1);
    ASSERT_CMD_RESPONSE(0, MissionManagerComponentBase::OPCODE_SCHEDULE_COLLECTION, 0,
    ...
    ASSERT_CMD_RESPONSE(1, MissionManagerComponentBase::OPCODE_SCHEDULE_COLLECTION, 1,
                        Fw::CmdResponse::VALIDATION_ERROR);
...
void MissionManagerTester::testRejectsInvalidCommandTransition() {
    this->clearHistory();
...
void MissionManagerTester::testEnterBaseModeCancelsPendingCollection() {
    this->clearHistory();
    ...
    ASSERT_CMD_RESPONSE_SIZE(2);
    ASSERT_CMD_RESPONSE(1, MissionManagerComponentBase::OPCODE_ENTER_BASE_MODE, 1,
                        Fw::CmdResponse::OK);
    ASSERT_EVENTS_ModeChanged_SIZE(2);
    ASSERT_EVENTS_ModeChanged(0, Components::MissionMode::COLLECTION_PENDING);
    ASSERT_EVENTS_ModeChanged(1, Components::MissionMode::BASE);
...
void MissionManagerTester::testCancelCollectionReturnsBaseAndCancels() {
    this->clearHistory();
    ...
    ASSERT_CMD_RESPONSE_SIZE(2);
    ASSERT_CMD_RESPONSE(1, MissionManagerComponentBase::OPCODE_CANCEL_COLLECTION, 1,
                        Fw::CmdResponse::OK);
    ASSERT_EVENTS_ModeChanged_SIZE(2);
    ASSERT_EVENTS_ModeChanged(1, Components::MissionMode::BASE);
    ASSERT_from_cancelRequestOut_SIZE(1);
