#ifndef Components_EpsDriver_Artemis_HPP
#define Components_EpsDriver_Artemis_HPP

#include "../../../external/artemis-pdu/src/pdu_protocol_v2.h"

#include "Components/EpsDriver_Artemis/EpsDriver_ArtemisComponentAc.hpp"
#include "Components/LinkCfg/LinkCfg.hpp"

namespace Components {

class EpsDriver_Artemis final : public EpsDriver_ArtemisComponentBase {
  public:
    EpsDriver_Artemis(const char* const compName);
    ~EpsDriver_Artemis();
