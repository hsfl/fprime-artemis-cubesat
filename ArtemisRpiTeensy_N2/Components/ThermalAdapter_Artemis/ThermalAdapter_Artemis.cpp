#include "Components/ThermalAdapter_Artemis/ThermalAdapter_Artemis.hpp"

namespace Components {

ThermalAdapter_Artemis::ThermalAdapter_Artemis(const char* const compName)
    : ThermalAdapter_ArtemisComponentBase(compName),
      m_lastRequestKey(0),
      m_requestCount(0),
...
ThermalAdapter_Artemis::~ThermalAdapter_Artemis() {}

void ThermalAdapter_Artemis::pingIn_handler(FwIndexType portNum, U32 key) {
    static_cast<void>(portNum);
    this->pingOut_out(0, key);
}

void ThermalAdapter_Artemis::requestIn_handler(FwIndexType portNum, U32 key) {
    static_cast<void>(portNum);
...
void ThermalAdapter_Artemis::updateThermalModel() {
...
U32 ThermalAdapter_Artemis::toStatusKey() const {
