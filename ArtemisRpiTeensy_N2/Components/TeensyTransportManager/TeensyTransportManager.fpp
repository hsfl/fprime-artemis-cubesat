module Components {
    @ Teensy transport manager for UART/RF link observability.
    active component TeensyTransportManager {
        ...
        @ Link status output to CommsApp (0=down, 1=acquiring, 2=locked, 3=degraded)
