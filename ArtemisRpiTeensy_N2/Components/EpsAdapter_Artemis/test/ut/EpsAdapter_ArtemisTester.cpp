...
EpsAdapter_ArtemisTester::EpsAdapter_ArtemisTester()
    : EpsAdapter_ArtemisGTestBase("EpsAdapter_ArtemisTester", MAX_HISTORY_SIZE),
      component("EpsAdapter_Artemis"),
      m_requests() {
    this->initComponents();
    this->connectPorts();
}
...
void EpsAdapter_ArtemisTester::from_teensyRequestOut_handler(FwIndexType portNum, Fw::Buffer& fwBuffer) {
...
void EpsAdapter_ArtemisTester::testTimeoutClearsPendingRequest() {
    this->clearHistory();
