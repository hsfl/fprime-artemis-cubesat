# Generated from config/rf_networks.json and ComCfg.fpp.in by tools/generate_transport_constants.py.
# Do not hand-edit; update the registry/template and regenerate.

# ======================================================================
# FPP template for configuration of the communications stack
# ======================================================================
...
module ComCfg {
    ...
    dictionary constant SpacecraftId = 0x0045

    @ Fixed size of CCSDS TM frames
    dictionary constant TmFrameFixedSize = 128  # RF MVP: keep TM frames small enough for low-rate Teensy/RF bridge
