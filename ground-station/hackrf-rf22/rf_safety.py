...
# One qualified student-facing C3M setup.  These values are deliberately
# centralized so the launcher, device defaults, and proof collector cannot
# silently drift apart.
BASELINE_RF_PATH_LABEL = "monopole-9to10in-no-attenuator"
BASELINE_TX_MODE = "ack"
BASELINE_TX_GAIN_DB = 16
BASELINE_RX_LNA_GAIN_DB = 8
